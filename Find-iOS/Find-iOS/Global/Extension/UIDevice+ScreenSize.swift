...
extension UIDevice {
    ...
    public var isiPone11ProMax: Bool {
        if UIDevice.current.userInterfaceIdiom == UIUserInterfaceIdiom.pad && (UIScreen.main.bounds.size.height == 896 && UIScreen.main.bounds.size.width == 414) {
            return true
        }
        return false
    }
