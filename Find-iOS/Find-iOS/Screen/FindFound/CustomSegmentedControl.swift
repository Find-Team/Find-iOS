...
class CustomSegmentedControl: UIView {
    ...
    var textColor:UIColor = .subGray1
    var selectorViewColor: UIColor = .find_DarkPurple
    var selectorTextColor: UIColor = .find_DarkPurple
    ...
    func setIndex(index:Int) {
        ...
        buttons.forEach({ $0.setTitleColor(.subGray1, for: .normal) })
    ...
    @objc func buttonAction(sender:UIButton) {
        ...
        for (buttonIndex, btn) in buttons.enumerated() {
            btn.setTitleColor(.subGray1, for: .normal)
